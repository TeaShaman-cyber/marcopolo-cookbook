...
class EvidenceTests(unittest.TestCase):
    def test_single_signal_cannot_be_likely(self):
        receipt = new_receipt(
            "mcp.marcopolo.dev", "hosting-identify", "2026-09-03T00:00:00Z"
        )
        add_observation(
            receipt, "http_header", "target", {"provider_candidate": "vercel"}
        )
